...
var randomize = document.querySelector(".randomize"); // rough hack, it's technically a class - matthew
var story = document.querySelector(".story"); // rough hack, it's technically a class - matthew
